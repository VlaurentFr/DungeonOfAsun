    ...
    return (
        <section ref={props.refProp} className="container">
            ...
            <div className="flex-wrapper row evenly middle-container">
                ...
                <img src="/DungeonOfAsun/Assets/VM.png" alt="Logo Université de la rochelle"/>
                <p>Visite Musée</p>
                </div>
                <div className="column app">
                <img src="/DungeonOfAsun/Assets/VP.png" alt="Logo Université de la rochelle"/>
                <p>Visite Patrimoine</p>
                </div>
                <div className="column app">
                <img src="/DungeonOfAsun/Assets/1024.png" alt="Logo Université de la rochelle"/>
